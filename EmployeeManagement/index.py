...
btnAdd = Button(btn_frame,  text="Add Details", width=15, font=("Calibri", 16, "bold"), fg="white",
                bg="#16a085", bd=0, command=Add_Details).grid(row=0, column=0)
...
btnClear = Button(btn_frame,  text="Clear Details", width=15, font=("Calibri", 16, "bold"), fg="white",
                bg="#f39c12",
...
tv.insert("",END, values=("ashok","ashok","ashok",))
tv['show'] = 'headings'
